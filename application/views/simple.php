	...
	<section>
		<div id="main-container">
			<div id="select-table-div">
				...
				<br>
				<div class="btn-group">
					<button id="select-table-btn" type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						Select Table
					</button>
					<div class="dropdown-menu" id="select-table-dropdown">
						<?php
						$query='SHOW TABLES';
						...
						while ($record = mysqli_fetch_assoc($result))
						{
							...
							echo "<button type='button' class='dropdown-item' id=". $sno . " value=". $tableName . ">{$tableName}</button> ";
