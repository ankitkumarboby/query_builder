	...
	<section>
		<div id="main-container">
			<div id="select-table-div">
				...
				<br>
                First Table: 
                <select id="table1" class="form-select" aria-label="Default select example">
                    <?php
                        $query='SHOW TABLES';
                        ...
                        while ($record = mysqli_fetch_assoc($result))
                        {
                            ...
                            echo '<option value="'.$sno.'"> '.$tableName.' </option>';
                            $sno = $sno + 1;   
                        }
                    ?>
                </select>
                Second Table: 
                <select id="table2" class="form-select" aria-label="Default select example">
                    <?php
                        $query='SHOW TABLES';
                        $result = mysqli_query($connect, $query);
                        $sno = 0;
                ...
                Join Type: 
                <select id="join-type" class="form-select" aria-label="Default select example">
                    <option value="0"> INNER JOIN </option>
                    <option value="1"> LEFT JOIN </option>
                    <option value="2"> RIGHT JOIN </option>
                </select>
                <br>
                First Column: 
                <select id="aval-column1" class="form-select" aria-label="Default select example">
                </select>
                Second Column: 
                <select id="aval-column2" class="form-select" aria-label="Default select example">
                </select>
                <br>
